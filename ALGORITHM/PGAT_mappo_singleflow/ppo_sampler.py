...
class TrajPoolSampler():
    def __init__(self, n_div, traj_pool, flag, prevent_batchsize_oom=False, mcv=None):
        ...
        self.warned = False
        assert flag=='train'
        req_dict =        ['avail_act', 'obs', 'action', 'actionLogProb', 'return', 'reward', 'value', '_OBS_Message_']
        req_dict_rename = ['avail_act', 'obs', 'action', 'actionLogProb', 'return', 'reward', 'state_value', '_OBS_Message_']
